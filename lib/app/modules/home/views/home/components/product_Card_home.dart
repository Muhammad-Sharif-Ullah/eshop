...
class ProductCard extends GetWidget<HomeController>{
  ...
  Widget build(BuildContext context) {
    int getRating()=> controller.products[index].rating!.fold<int>(0, (previousValue, element) => (previousValue + element))~/controller.products[index].rating!.length;
    return Container(
      width: 200,
      // height: 350,
        ...
        FutureImageWidget(url: controller.products[index].images!.first, height: 184,width: 200),
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(controller.products[index].brand!,//'${product.brand}'
                          overflow: TextOverflow.ellipsis,
                          style: context.textTheme.caption?.copyWith(
                              color: Colors.grey, letterSpacing: -.3)),
                      Text(controller.products[index].name!, ///'${product.name}'
                          overflow: TextOverflow.ellipsis,
                          style: context.textTheme.subtitle1
                              ?.copyWith(letterSpacing: -.5)),
                      PriceText(context: context, oldP: controller.products[index].oldPrice, newP: controller.products[index].oldPrice),
                    ],
                  ),
                ),
              ],
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: Text(
                  controller.products[index].discount != 0 ? "-${controller.products[index].discount}%" : " New ",
